...
class Customer
{
     ...
     * @var boolean
     * 
     * @ORM\Column(name="kindOfInvoiceCustomer", type="boolean")
     */
    private $kindOfInvoiceCustomer;
    ...
    /**
     * Get the value of kindOfInvoiceCustomer
     *
     * @return  boolean
     */ 
    public function getKindOfInvoiceCustomer()
    {
        return $this->kindOfInvoiceCustomer;
    }

    /**
     * Set the value of kindOfInvoiceCustomer
     *
     * @param  boolean  $kindOfInvoiceCustomer
     *
     * @return  self
     */ 
    public function setKindOfInvoiceCustomer($kindOfInvoiceCustomer)
    {
        $this->kindOfInvoiceCustomer = $kindOfInvoiceCustomer;
